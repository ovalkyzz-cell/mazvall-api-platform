...
const allEndpoints: Endpoint[] = [
  ...
  { method: "GET", path: "/api/info/wilayah", title: "Wilayah Indonesia", desc: "Data wilayah lengkap (provinsi/kota/kecamatan/desa)", category: "Info", icon: Globe, params: [{ name: "type", placeholder: "provinces, regencies, districts, villages", required: true }, { name: "id", placeholder: "ID wilayah" }, { name: "sub", placeholder: "regencies, districts, villages" }, { name: "geojson", placeholder: "true untuk geojson" }, { name: "adjacent", placeholder: "true untuk wilayah sekitar" }, { name: "level", placeholder: "regencies, districts, villages" }] },
  { method: "GET", path: "/api/info/symbols", title: "Simbol Provinsi", desc: "Simbol lambang provinsi Indonesia", category: "Info", icon: Globe, params: [{ name: "id", placeholder: "ID Provinsi (opsional)" }] },
  { method: "GET", path: "/api/info/postal", title: "Kode Pos", desc: "Cari data kode pos Indonesia", category: "Info", icon: Hash, params: [{ name: "code", placeholder: "Kode pos (40123)", required: true }] },
  ...
  { method: "GET", path: "/api/tools/nik", title: "Parse NIK", desc: "Parse NIK KTP Indonesia", category: "Tools", icon: Hash, params: [{ name: "nik", placeholder: "Nomor NIK 16 digit", required: true }, { name: "reference_year", placeholder: "2026" }, { name: "century_override", placeholder: "2000" }] },
  { method: "GET", path: "/api/tools/myinstants", title: "MyInstants", desc: "Sound effects & meme sounds", category: "Tools", icon: Music, params: [{ name: "action", placeholder: "trending, search, detail, recent, best, uploaded, favorites", required: true }, { name: "q", placeholder: "Kata kunci (untuk search/trending/best)" }, { name: "id", placeholder: "ID sound (untuk detail)" }, { name: "username", placeholder: "Username (untuk uploaded/favorites)" }] },
